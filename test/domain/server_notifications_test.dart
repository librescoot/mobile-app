...
void main() {
  ...
  group('matchAppId', () {
    test('an entry without the field matches every build', () {
      expect(matchAppId(value: null, applicationId: 'org.librescoot.mobile.unu'), ScopeMatch.match);
      expect(matchAppId(value: null, applicationId: null), ScopeMatch.match);
    });

    test('accepts one application id or a list, exactly', () {
      expect(
        matchAppId(value: 'org.librescoot.mobile.unu', applicationId: 'org.librescoot.mobile.unu'),
        ScopeMatch.match,
      );
      expect(
        matchAppId(
          value: ['org.librescoot.mobile.unu', 'org.librescoot.mobile.unu.profile'],
          applicationId: 'org.librescoot.mobile.unu.profile',
        ),
        ScopeMatch.match,
      );
      expect(
        matchAppId(value: 'org.librescoot.mobile.unu', applicationId: 'org.librescoot.mobile.unu.debug'),
        ScopeMatch.mismatch,
        reason: 'the debug and profile builds need their own entry or a wildcard',
      );
    });
    ...
    test('a trailing star matches every build type of one application', () {
      for (final id in [
        ...
        'org.librescoot.mobile.unu.profile',
        'org.librescoot.mobile.unu.debug',
      ]) {
        expect(matchAppId(value: 'org.librescoot.mobile.unu*', applicationId: id), ScopeMatch.match);
      }
      expect(
        matchAppId(value: 'org.librescoot.mobile.unu*', applicationId: 'de.freal.unustasis'),
        ScopeMatch.mismatch,
      );
      expect(
        matchAppId(value: 'org.librescoot.mobile.unu.*', applicationId: 'org.librescoot.mobile.unu'),
    ...
    test('an unusable scope never matches', () {
      expect(matchAppId(value: 'org.librescoot.mobile.unu', applicationId: null), ScopeMatch.malformed);
      expect(matchAppId(value: 'org.librescoot.mobile.unu', applicationId: ''), ScopeMatch.malformed);
      expect(matchAppId(value: 42, applicationId: 'org.librescoot.mobile.unu'), ScopeMatch.malformed);
      expect(
        matchAppId(value: ['org.librescoot.mobile.unu', 7], applicationId: 'org.librescoot.mobile.unu'),
        ScopeMatch.malformed,
      );
      expect(matchAppId(value: <String>[], applicationId: 'org.librescoot.mobile.unu'), ScopeMatch.malformed);
      expect(matchAppId(value: '', applicationId: 'org.librescoot.mobile.unu'), ScopeMatch.malformed);
      expect(
        matchAppId(value: '*', applicationId: 'org.librescoot.mobile.unu'),
        ScopeMatch.malformed,
