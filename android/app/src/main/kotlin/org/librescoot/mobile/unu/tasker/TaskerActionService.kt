 ...
 * broadcast. A foreground service does have that claim.
 */
class TaskerActionService : Service() {
    ...
    private fun run(action: TaskerAction, completionIntent: Intent?) = Thread {
        ...
        stopIfIdle()
    }.apply { name = "librescoot-tasker-${action.key}" }.start()
    ...
    companion object {
        ...
        private const val WAKE_LOCK_TAG = "librescoot:tasker-action"
        private const val WAKE_LOCK_GRACE_MS = 5_000L
        private const val EXTRA_ACTION = "org.librescoot.mobile.unu.tasker.ACTION_KEY"
        private const val EXTRA_COMPLETION_INTENT = "org.librescoot.mobile.unu.tasker.COMPLETION_INTENT"
        ...
        fun reply(context: Context, completionIntent: Intent?, result: String) {
            ...
            completionIntent
                ...
                .putExtra(
                    TaskerPluginProtocol.EXTRA_VARIABLES_BUNDLE,
                    Bundle().apply {
