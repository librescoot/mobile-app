...
- **Librescoot administration:** Add, name and remove keycards; manage alarm and honk settings, auto-standby and auto-hibernation timers, scheduled hibernation, battery keep-active and cellular APN. Check installed system versions, synchronize the clock, select USB update mode or service mode, and check for and install supported firmware updates over BLE.
