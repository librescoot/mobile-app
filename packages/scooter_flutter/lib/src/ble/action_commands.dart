...
Future<void> unlockScooter(
  ...
  await sendCommand(scooter, repo, unlockCommand, isCurrent: isCurrent);
}

Future<void> lockScooter(
    BluetoothDevice? scooter, CharacteristicRepository repo,
    {bool Function()? isCurrent}) async {
  await sendCommand(scooter, repo, lockCommand, isCurrent: isCurrent);
}

Future<void> openSeatCommand(
    BluetoothDevice? scooter, CharacteristicRepository repo,
    {bool Function()? isCurrent}) async {
  await sendCommand(scooter, repo, seatCommand, isCurrent: isCurrent);
}
